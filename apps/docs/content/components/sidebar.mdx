...
# Admin panel demo
---
A full-sized sample Admin panel can be seen [here](https://dashboard.github.com/mrwick1/astra-ui/).
...
```tsx
import { Sidebar, useSidebar } from '@astra-ui/core';
```
...
<SidebarShowcase showcase="render-as" />
...
```tsx
import { useSidebar, Sidebar, Button } from '@astra-ui/core';
