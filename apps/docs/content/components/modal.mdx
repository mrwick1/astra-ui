...
```tsx
import { Modal } from '@astra-ui/core';
```
...
import { Modal, Card, Button } from '@astra-ui/core';
...
```tsx
import { Button, Card, Modal, Text } from '@astra-ui/core';
import { useState } from 'react';
...
```tsx
import { Button, Card, Modal } from '@astra-ui/core';
import { useState } from 'react';
import * as React from 'react';
import { X } from '@phosphor-icons/react';
