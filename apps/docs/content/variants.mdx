...
Then, you can copy all the variants from the [@astra-ui/core](https://github.com/astra-ui/astra-ui/tree/main/packages/core/src/theme/variants) package and customize them as you wish. Finally you can import them into your `App.tsx` file and pass them to the `VariantProvider` component.
