      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
        <FeatureCard
          ...
          description="We all love headless UI libraries, but sometimes we just want to get started quickly.
            Astra UI comes with pre-styled components that you can use out of the box."
          icon={
            <svg
        ...
        <FeatureCard
          title="Themeable"
          description="Using the CVA library, Astra UI provides a themeable styling system that allows you to
        ...
        <FeatureCard
          title="Accessible"
          description="Astra UI is built with accessibility in mind. All components are WAI-ARIA compliant and
        ...
        <FeatureCard
          ...
          description="Astra UI comes with a detailed documentation that includes interactive examples and
