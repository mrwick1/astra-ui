import { Accordion, AccordionProps } from '@astra-ui/core';
import * as React from 'react';

const accordionItems = [
  {
    anchor: 'item-1',
    header: 'What is Astra UI?',
    icon: (
    ...
    body: "Astra UI is a React component library that provides a set of accessible, reusable, and customizable components to help you build your next project. We've designed our components to be flexible and easy to use, so you can focus on what matters most: building great user experiences.",
  },
  {
    anchor: 'item-2',
    ...
    body: "Getting started with Astra UI is easy! Simply install the package using your package manager of choice, and you're ready to go. We've also included a set of Storybook stories to help you get familiar with our components and how to use them.",
  },
  {
    anchor: 'item-3',
    ...
    body: "We're always looking for new contributors to help us improve Astra UI! If you'd like to contribute, please check out our contribution guidelines to get started. We're looking forward to working with you!",
  },
  {
    anchor: 'item-4',
    ...
    body: "If you'd like to learn more about Astra UI, please visit our website. You can also follow us on Twitter to stay up to date with the latest news and updates.",
  },
];
...
export const AccordionCode = (props: any) => {
  ...
  return `import { Accordion } from '@astra-ui/core';
