import { Button, ToastContainer, ToastProps, useToast } from '@astra-ui/core';
import { ToastContainerProps } from '@astra-ui/core/dist/components/Toast/ToastContainer/ToastContainer.types';
...
export const ToastCode = (props: any) => {
  ...
  return `import { ToastContainer, useToast } from '@astra-ui/core';
