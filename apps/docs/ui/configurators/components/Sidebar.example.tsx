...
import { Button, Overlay, Sidebar, SidebarProps, SidebarState, useSidebar } from '@astra-ui/core';
...
export const SidebarCode = (props: any) => {
  ...
  return `import { Sidebar, useSidebar, Overlay } from '@astra-ui/core';
  ...
  return (
    <div className="relative flex flex-row w-full h-full min-h-[35rem]">
      ...
      >
        <Sidebar.Head>
          <Sidebar.Head.Logo>
            <Image src="/images/rewind.svg" width={48} height={48} alt="Astra UI" />
          </Sidebar.Head.Logo>
          <Sidebar.Head.Title>Astra UI</Sidebar.Head.Title>
          <Sidebar.Head.Toggle />
        </Sidebar.Head>
        ...
        <Sidebar.Footer>
          <div className="flex flex-col justify-center items-center text-sm">
            <span className="font-semibold">Astra UI</span>
