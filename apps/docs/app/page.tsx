...
export const generateMetadata = ({ params }) => {
  const title = 'Astra UI - A fully customizable React-TailwindCSS component library';
  const description =
    'Astra UI offers a range of accessible, highly customizable components that can be easily integrated into any react project.';
  ...
  return {
    ...
    openGraph: {
      locale: 'en_US',
      url: 'https://github.com/mrwick1/astra-ui',
      title,
      description,
