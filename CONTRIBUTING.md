...
Each component should be in its own directory inside `astra-ui/packages/core/src/components`. The [Button](https://github.com/astra-ui/astra-ui/tree/main/packages/core/src/components/Button) component can be used as an example.
